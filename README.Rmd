...
```
4. Adicionar a camada de resistência na pasta onde será rodado Omniscape (no exemplo aqui `test_area.tif`)
5. Criar um arquivo .INI com os parâmetros para rodar. Aqui:  Um exemplo (`test.INI`) com parâmetros default. Ver a documentação!
```{bash}
[Required]
